...
void
buildBoard (char board[ROW][COLUMN], char words[])
{
  ...
  int dir, y_axis, x_axis, len_word; //(y,x)=(row,column)
  ...
  dir = rand () % 8 + 1; // directions 1-8
  printf ("Dir for the %s: %d\n", words, dir);
  ...
  switch (dir)
    ...
    case 5:
      ...
      diag_down_left_to_right (board, words, y_axis, x_axis, len_word);
      break;
    case 6:
      /* Place the word downward diagonal, right to left */
      diag_down_right_to_left (board, words, y_axis, x_axis, len_word);
      break;
    case 7:
      /* Place the word upward diagonal, left to right */
      diag_up_left_to_right (board, words, y_axis, x_axis, len_word);
      break;
    case 8:
      /* Place the word upward diagonal, right to left */
      diag_up_right_to_left (board, words, y_axis, x_axis, len_word);
      break;
    default:
      break;
    }
